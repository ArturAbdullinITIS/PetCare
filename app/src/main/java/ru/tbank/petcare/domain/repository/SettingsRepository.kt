...
interface SettingsRepository {
    ...
    suspend fun updateWalkNotifications(enabled: Boolean)
    suspend fun updateGroomingNotifications(enabled: Boolean)
    suspend fun updateVetNotifications(enabled: Boolean)
}
